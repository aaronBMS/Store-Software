 ...
 * @author Aaron
 */
public class DetalleCVista extends javax.swing.JFrame {

    /**
     * Creates new form DetalleCVista
     */
    public DetalleCVista() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jtxtCodigoCompra.setBackground(new java.awt.Color(69, 73, 75));
        jtxtCodigoCompra.setForeground(new java.awt.Color(187, 187, 188));
        jtxtCodigoCompra.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        getContentPane().add(jtxtCodigoCompra, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 20, 130, 30));

        jlblCodigo1.setForeground(new java.awt.Color(187, 187, 188));
        jlblCodigo1.setText("Código de Compra:");
        getContentPane().add(jlblCodigo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 20, 120, 30));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DetalleCVista.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DetalleCVista().setVisible(true);
            }
        });
    }
    ...
    public javax.swing.JTextField jtxtCodigoCompra;
